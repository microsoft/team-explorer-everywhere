...
public class SaveBuildAgentCommand extends TFSCommand {
     ...
     * @param buildAgent
     */
    public SaveBuildAgentCommand(final IBuildServer buildServer, final IBuildAgent buildAgent) {
    ...
    public String getName() {
        return (Messages.getString("SaveBuildAgentCommand.SavingBuildAgentCommandText")); //$NON-NLS-1$
    }

    @Override
    public String getErrorDescription() {
        return (Messages.getString("SaveBuildAgentCommand.SavingBuildAgentErrorText")); //$NON-NLS-1$
    }

    @Override
    public String getLoggingDescription() {
        return (Messages.getString("SaveBuildAgentCommand.SavingBuildAgentCommandText", LocaleUtil.ROOT)); //$NON-NLS-1$
    }
    ...
    protected IStatus doRun(final IProgressMonitor progressMonitor) throws Exception {
        buildServer.saveBuildAgents(new IBuildAgent[] {
            buildAgent
        });
