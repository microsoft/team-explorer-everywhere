 ...
 */
public class _Repository4Soap_QueryShelvedChangesResponse
    implements ElementDeserializable
{
    // No attributes    

    // Elements
    protected _PendingSet[] queryShelvedChangesResult;
    protected _Failure[] failures;

    public _Repository4Soap_QueryShelvedChangesResponse()
    {
        super();
    }

    public _Repository4Soap_QueryShelvedChangesResponse(
        final _PendingSet[] queryShelvedChangesResult,
        final _Failure[] failures)
    {
        // TODO : Call super() instead of setting all fields directly?
        setQueryShelvedChangesResult(queryShelvedChangesResult);
        setFailures(failures);
    }

    public _PendingSet[] getQueryShelvedChangesResult()
    {
        return this.queryShelvedChangesResult;
    }

    public void setQueryShelvedChangesResult(_PendingSet[] value)
    {
        this.queryShelvedChangesResult = value;
    }
        ...
        throws XMLStreamException
    {
        ...
        do
        {
            ...
            if (event == XMLStreamConstants.START_ELEMENT)
            {
                ...
                if (localName.equalsIgnoreCase("QueryShelvedChangesResult"))
                {
                    /*
                    ...
                    this.queryShelvedChangesResult = (_PendingSet[]) list0.toArray(new _PendingSet[list0.size()]);
                }
