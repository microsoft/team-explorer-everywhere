 ...
 */
public class _RepositorySoap_QueryHistoryResponse
    implements ElementDeserializable
{
    // No attributes    

    // Elements
    protected _Changeset[] queryHistoryResult;

    public _RepositorySoap_QueryHistoryResponse()
    {
        super();
    }

    public _RepositorySoap_QueryHistoryResponse(final _Changeset[] queryHistoryResult)
    {
        // TODO : Call super() instead of setting all fields directly?
        setQueryHistoryResult(queryHistoryResult);
    }

    public _Changeset[] getQueryHistoryResult()
    {
        return this.queryHistoryResult;
    }

    public void setQueryHistoryResult(_Changeset[] value)
    {
        this.queryHistoryResult = value;
    }
        ...
        throws XMLStreamException
    {
        ...
        do
        {
            ...
            if (event == XMLStreamConstants.START_ELEMENT)
            {
                ...
                if (localName.equalsIgnoreCase("QueryHistoryResult"))
                {
                    /*
                    ...
                    this.queryHistoryResult = (_Changeset[]) list0.toArray(new _Changeset[list0.size()]);
                }
                else
                {
