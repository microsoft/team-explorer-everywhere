 ...
 */
public final class _WorkingFolderType
    extends Enumeration
{
    /**
    ...
    public static final _WorkingFolderType Map = new _WorkingFolderType("Map");
    public static final _WorkingFolderType Cloak = new _WorkingFolderType("Cloak");

    private _WorkingFolderType(final String name)
    {
        super(name, _WorkingFolderType.VALUES_TO_INSTANCES);
    }
     ...
     */
    public static _WorkingFolderType fromString(final String value)
        throws SOAPSerializationException
    {
        return (_WorkingFolderType) Enumeration.fromString(
            value,
            _WorkingFolderType.VALUES_TO_INSTANCES);
    }
}
