 ...
 */
public final class _RecursionType
    extends Enumeration
{
    /**
    ...
    public static final _RecursionType None = new _RecursionType("None");
    public static final _RecursionType OneLevel = new _RecursionType("OneLevel");
    public static final _RecursionType Full = new _RecursionType("Full");

    private _RecursionType(final String name)
    {
        super(name, _RecursionType.VALUES_TO_INSTANCES);
    }
     ...
     */
    public static _RecursionType fromString(final String value)
        throws SOAPSerializationException
    {
        return (_RecursionType) Enumeration.fromString(
            value,
            _RecursionType.VALUES_TO_INSTANCES);
    }
}
