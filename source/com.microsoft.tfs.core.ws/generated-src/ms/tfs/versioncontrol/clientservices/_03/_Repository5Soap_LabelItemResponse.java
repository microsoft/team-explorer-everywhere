 ...
 */
public class _Repository5Soap_LabelItemResponse
    implements ElementDeserializable
{
    // No attributes    

    // Elements
    protected _LabelResult[] labelItemResult;
    protected _Failure[] failures;

    public _Repository5Soap_LabelItemResponse()
    {
        super();
    }

    public _Repository5Soap_LabelItemResponse(
        final _LabelResult[] labelItemResult,
        final _Failure[] failures)
    {
        // TODO : Call super() instead of setting all fields directly?
        setLabelItemResult(labelItemResult);
        setFailures(failures);
    }

    public _LabelResult[] getLabelItemResult()
    {
        return this.labelItemResult;
    }

    public void setLabelItemResult(_LabelResult[] value)
    {
        this.labelItemResult = value;
    }
        ...
        throws XMLStreamException
    {
        ...
        do
        {
            ...
            if (event == XMLStreamConstants.START_ELEMENT)
            {
                ...
                if (localName.equalsIgnoreCase("LabelItemResult"))
                {
                    /*
                    ...
                    this.labelItemResult = (_LabelResult[]) list0.toArray(new _LabelResult[list0.size()]);
                }
