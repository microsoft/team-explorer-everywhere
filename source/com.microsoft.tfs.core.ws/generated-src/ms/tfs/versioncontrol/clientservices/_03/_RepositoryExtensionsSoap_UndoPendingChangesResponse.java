 ...
 */
public class _RepositoryExtensionsSoap_UndoPendingChangesResponse
    implements ElementDeserializable
{
    // No attributes    

    // Elements
    protected _GetOperation[] undoPendingChangesResult;
    protected _Failure[] failures;
    protected int changePendedFlags;

    public _RepositoryExtensionsSoap_UndoPendingChangesResponse()
    {
        super();
    }

    public _RepositoryExtensionsSoap_UndoPendingChangesResponse(
        final _GetOperation[] undoPendingChangesResult,
        final _Failure[] failures,
        final int changePendedFlags)
    {
        // TODO : Call super() instead of setting all fields directly?
        setUndoPendingChangesResult(undoPendingChangesResult);
        setFailures(failures);
        setChangePendedFlags(changePendedFlags);
    }

    public _GetOperation[] getUndoPendingChangesResult()
    {
        return this.undoPendingChangesResult;
    }

    public void setUndoPendingChangesResult(_GetOperation[] value)
    {
        this.undoPendingChangesResult = value;
    }
        ...
        throws XMLStreamException
    {
        ...
        do
        {
            ...
            if (event == XMLStreamConstants.START_ELEMENT)
            {
                ...
                if (localName.equalsIgnoreCase("UndoPendingChangesResult"))
                {
                    /*
                    ...
                    this.undoPendingChangesResult = (_GetOperation[]) list0.toArray(new _GetOperation[list0.size()]);
                }
