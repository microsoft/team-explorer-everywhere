 ...
 */
public class _RepositorySoap_QueryChangesetResponse
    implements ElementDeserializable
{
    // No attributes    

    // Elements
    protected _Changeset queryChangesetResult;

    public _RepositorySoap_QueryChangesetResponse()
    {
        super();
    }

    public _RepositorySoap_QueryChangesetResponse(final _Changeset queryChangesetResult)
    {
        // TODO : Call super() instead of setting all fields directly?
        setQueryChangesetResult(queryChangesetResult);
    }

    public _Changeset getQueryChangesetResult()
    {
        return this.queryChangesetResult;
    }

    public void setQueryChangesetResult(_Changeset value)
    {
        this.queryChangesetResult = value;
    }
        ...
        throws XMLStreamException
    {
        ...
        do
        {
            ...
            if (event == XMLStreamConstants.START_ELEMENT)
            {
                ...
                if (localName.equalsIgnoreCase("QueryChangesetResult"))
                {
                    this.queryChangesetResult = new _Changeset();
                    this.queryChangesetResult.readFromElement(reader);
                }
                else
                {
