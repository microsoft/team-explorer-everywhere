 ...
 */
public class _Repository5Soap_UndoPendingChangesInLocalWorkspaceResponse
    implements ElementDeserializable
{
    // No attributes    

    // Elements
    protected _GetOperation[] undoPendingChangesInLocalWorkspaceResult;
    protected _Failure[] failures;
    protected int changePendedFlags;

    public _Repository5Soap_UndoPendingChangesInLocalWorkspaceResponse()
    {
        super();
    }

    public _Repository5Soap_UndoPendingChangesInLocalWorkspaceResponse(
        final _GetOperation[] undoPendingChangesInLocalWorkspaceResult,
        final _Failure[] failures,
        final int changePendedFlags)
    {
        // TODO : Call super() instead of setting all fields directly?
        setUndoPendingChangesInLocalWorkspaceResult(undoPendingChangesInLocalWorkspaceResult);
        setFailures(failures);
        setChangePendedFlags(changePendedFlags);
    }

    public _GetOperation[] getUndoPendingChangesInLocalWorkspaceResult()
    {
        return this.undoPendingChangesInLocalWorkspaceResult;
    }

    public void setUndoPendingChangesInLocalWorkspaceResult(_GetOperation[] value)
    {
        this.undoPendingChangesInLocalWorkspaceResult = value;
    }
        ...
        throws XMLStreamException
    {
        ...
        do
        {
            ...
            if (event == XMLStreamConstants.START_ELEMENT)
            {
                ...
                if (localName.equalsIgnoreCase("UndoPendingChangesInLocalWorkspaceResult"))
                {
                    /*
                    ...
                    this.undoPendingChangesInLocalWorkspaceResult = (_GetOperation[]) list0.toArray(
                                new _GetOperation[list0.size()]);
                }
