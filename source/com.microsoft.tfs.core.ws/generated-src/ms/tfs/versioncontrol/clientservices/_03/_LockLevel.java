    ...
    extends Enumeration
{
    ...
    public static final _LockLevel None = new _LockLevel("None");
    public static final _LockLevel Checkin = new _LockLevel("Checkin");
    public static final _LockLevel CheckOut = new _LockLevel("CheckOut");
    public static final _LockLevel Unchanged = new _LockLevel("Unchanged");

    private _LockLevel(final String name)
    {
        super(name, _LockLevel.VALUES_TO_INSTANCES);
    }
     ...
     */
    public static _LockLevel fromString(final String value)
        throws SOAPSerializationException
    {
        return (_LockLevel) Enumeration.fromString(
            value,
            _LockLevel.VALUES_TO_INSTANCES);
    }
}
