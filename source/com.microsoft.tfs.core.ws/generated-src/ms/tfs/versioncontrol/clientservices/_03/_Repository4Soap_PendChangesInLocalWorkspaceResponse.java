 ...
 */
public class _Repository4Soap_PendChangesInLocalWorkspaceResponse
    implements ElementDeserializable
{
    // No attributes    

    // Elements
    protected _GetOperation[] pendChangesInLocalWorkspaceResult;
    protected _Failure[] failures;
    protected int changePendedFlags;

    public _Repository4Soap_PendChangesInLocalWorkspaceResponse()
    {
        super();
    }

    public _Repository4Soap_PendChangesInLocalWorkspaceResponse(
        final _GetOperation[] pendChangesInLocalWorkspaceResult,
        final _Failure[] failures,
        final int changePendedFlags)
    {
        // TODO : Call super() instead of setting all fields directly?
        setPendChangesInLocalWorkspaceResult(pendChangesInLocalWorkspaceResult);
        setFailures(failures);
        setChangePendedFlags(changePendedFlags);
    }

    public _GetOperation[] getPendChangesInLocalWorkspaceResult()
    {
        return this.pendChangesInLocalWorkspaceResult;
    }

    public void setPendChangesInLocalWorkspaceResult(_GetOperation[] value)
    {
        this.pendChangesInLocalWorkspaceResult = value;
    }
        ...
        throws XMLStreamException
    {
        ...
        do
        {
            ...
            if (event == XMLStreamConstants.START_ELEMENT)
            {
                ...
                if (localName.equalsIgnoreCase("PendChangesInLocalWorkspaceResult"))
                {
                    /*
                    ...
                    this.pendChangesInLocalWorkspaceResult = (_GetOperation[]) list0.toArray(
