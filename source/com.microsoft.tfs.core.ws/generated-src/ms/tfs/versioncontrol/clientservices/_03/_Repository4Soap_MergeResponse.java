 ...
 */
public class _Repository4Soap_MergeResponse
    implements ElementDeserializable
{
    ...
    public _Repository4Soap_MergeResponse()
    {
        super();
    }

    public _Repository4Soap_MergeResponse(
        final _GetOperation[] mergeResult,
    ...
    public void setMergeResult(_GetOperation[] value)
    {
        ...
        do
        {
            ...
            if (event == XMLStreamConstants.START_ELEMENT)
            {
                ...
                if (localName.equalsIgnoreCase("MergeResult"))
                {
                    ...
                    this.mergeResult = (_GetOperation[]) list0.toArray(new _GetOperation[list0.size()]);
                }
