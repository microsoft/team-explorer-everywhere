 ...
 */
public final class _LabelChildOption
    extends Enumeration
{
    /**
    ...
    public static final _LabelChildOption Fail = new _LabelChildOption("Fail");
    public static final _LabelChildOption Replace = new _LabelChildOption("Replace");
    public static final _LabelChildOption Merge = new _LabelChildOption("Merge");

    private _LabelChildOption(final String name)
    {
        super(name, _LabelChildOption.VALUES_TO_INSTANCES);
    }
     ...
     */
    public static _LabelChildOption fromString(final String value)
        throws SOAPSerializationException
    {
        return (_LabelChildOption) Enumeration.fromString(
            value,
            _LabelChildOption.VALUES_TO_INSTANCES);
    }
}
