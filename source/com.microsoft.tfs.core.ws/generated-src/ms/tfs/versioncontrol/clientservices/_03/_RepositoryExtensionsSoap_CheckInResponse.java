 ...
 */
public class _RepositoryExtensionsSoap_CheckInResponse
    implements ElementDeserializable
{
    ...
    public _RepositoryExtensionsSoap_CheckInResponse()
    {
        super();
    }

    public _RepositoryExtensionsSoap_CheckInResponse(
        final _CheckinResult checkInResult,
    ...
    public void setCheckInResult(_CheckinResult value)
    {
        ...
        do
        {
            ...
            if (event == XMLStreamConstants.START_ELEMENT)
            {
                ...
                if (localName.equalsIgnoreCase("CheckInResult"))
                {
                    ...
                    this.checkInResult.readFromElement(reader);
                }
