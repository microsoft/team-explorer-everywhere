 ...
 */
public final class _DeletedState
    extends Enumeration
{
    /**
    ...
    private _DeletedState(final String name)
    {
        super(name, _DeletedState.VALUES_TO_INSTANCES);
    }
     ...
     */
    public static _DeletedState fromString(final String value)
        throws SOAPSerializationException
    {
        return (_DeletedState) Enumeration.fromString(
            value,
            _DeletedState.VALUES_TO_INSTANCES);
    }
}
