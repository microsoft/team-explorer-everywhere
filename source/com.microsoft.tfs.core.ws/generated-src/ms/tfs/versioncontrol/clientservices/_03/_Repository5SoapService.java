 ...
 * ClientServices/03}Repository5SoapService
 */
public class _Repository5SoapService
    ...
    implements _Repository5Soap
{
    private static final QName PORT_QNAME = new QName(
        ...
        "Repository5SoapService");
    private static final String ENDPOINT_PATH = "/tfs/DefaultCollection/VersionControl/v5.0/Repository.asmx";

    public _Repository5SoapService(final URI endpoint, final QName port)
    {
        super(endpoint, port);
    }

    public _Repository5SoapService(final HttpClient client, URI endpoint, QName port)
    {
    ...
    {
        return _Repository5SoapService.PORT_QNAME;
    }
    ...
    {
        return _Repository5SoapService.ENDPOINT_PATH;
    }
