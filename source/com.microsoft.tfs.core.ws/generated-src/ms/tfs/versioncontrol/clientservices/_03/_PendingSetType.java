 ...
 */
public final class _PendingSetType
    extends Enumeration
{
    /**
    ...
    public static final _PendingSetType Workspace = new _PendingSetType("Workspace");
    public static final _PendingSetType Shelveset = new _PendingSetType("Shelveset");

    private _PendingSetType(final String name)
    {
        super(name, _PendingSetType.VALUES_TO_INSTANCES);
    }
     ...
     */
    public static _PendingSetType fromString(final String value)
        throws SOAPSerializationException
    {
        return (_PendingSetType) Enumeration.fromString(
            value,
            _PendingSetType.VALUES_TO_INSTANCES);
    }
}
