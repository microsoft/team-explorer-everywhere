 ...
 */
public class _ClientService2Soap_BulkUpdateResponse
    implements ElementDeserializable
{
    // No attributes    

    // Elements
    protected boolean bulkUpdateResult;
    protected AnyContentType result;
    protected String dbStamp;
    protected AnyContentType metadata;

    public _ClientService2Soap_BulkUpdateResponse()
    {
        super();
    }

    public _ClientService2Soap_BulkUpdateResponse(
        final boolean bulkUpdateResult,
        final AnyContentType result,
        final String dbStamp,
        final AnyContentType metadata)
    {
        // TODO : Call super() instead of setting all fields directly?
        setBulkUpdateResult(bulkUpdateResult);
        setResult(result);
        setDbStamp(dbStamp);
        setMetadata(metadata);
    }

    public boolean isBulkUpdateResult()
    {
        return this.bulkUpdateResult;
    }

    public void setBulkUpdateResult(boolean value)
    {
        this.bulkUpdateResult = value;
    }
        ...
        throws XMLStreamException
    {
        ...
        do
        {
            ...
            if (event == XMLStreamConstants.START_ELEMENT)
            {
                ...
                if (localName.equalsIgnoreCase("BulkUpdateResult"))
                {
                    this.bulkUpdateResult = XMLConvert.toBoolean(reader.getElementText());
                }
