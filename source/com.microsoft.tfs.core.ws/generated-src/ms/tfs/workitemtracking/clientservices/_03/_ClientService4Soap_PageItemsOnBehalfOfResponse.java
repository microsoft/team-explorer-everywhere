 ...
 */
public class _ClientService4Soap_PageItemsOnBehalfOfResponse
    implements ElementDeserializable
{
    ...
    public _ClientService4Soap_PageItemsOnBehalfOfResponse()
    {
        super();
    }

    public _ClientService4Soap_PageItemsOnBehalfOfResponse(final AnyContentType items)
    {
