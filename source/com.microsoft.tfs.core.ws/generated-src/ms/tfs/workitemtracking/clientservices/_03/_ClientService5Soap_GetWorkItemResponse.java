 ...
 */
public class _ClientService5Soap_GetWorkItemResponse
    implements ElementDeserializable
{
    // No attributes    

    // Elements
    protected AnyContentType workItem;
    protected String dbStamp;
    protected AnyContentType metadata;

    public _ClientService5Soap_GetWorkItemResponse()
    {
        super();
    }

    public _ClientService5Soap_GetWorkItemResponse(
        final AnyContentType workItem,
    ...
    public AnyContentType getWorkItem()
    {
        return this.workItem;
    }

    public void setWorkItem(AnyContentType value)
    {
        this.workItem = value;
    }
        ...
        throws XMLStreamException
    {
        ...
        do
        {
            ...
            if (event == XMLStreamConstants.START_ELEMENT)
            {
                ...
                if (localName.equalsIgnoreCase("workItem"))
                {
                    if (this.workItem == null)
                    {
                        throw new XMLStreamException(
                                "An AnyContentType implementation must be supplied by the caller "
                                + "for the 'workItem' field before deserialization can occur.");
                    }

                    this.workItem.readFromElement(reader);
                }
