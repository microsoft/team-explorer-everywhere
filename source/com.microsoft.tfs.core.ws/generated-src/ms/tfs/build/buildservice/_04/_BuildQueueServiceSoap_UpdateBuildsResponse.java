 ...
 */
public class _BuildQueueServiceSoap_UpdateBuildsResponse
    implements ElementDeserializable
{
    // No attributes    

    // Elements
    protected _BuildQueueQueryResult updateBuildsResult;

    public _BuildQueueServiceSoap_UpdateBuildsResponse()
    {
        super();
    }

    public _BuildQueueServiceSoap_UpdateBuildsResponse(final _BuildQueueQueryResult updateBuildsResult)
    {
        // TODO : Call super() instead of setting all fields directly?
        setUpdateBuildsResult(updateBuildsResult);
    }

    public _BuildQueueQueryResult getUpdateBuildsResult()
    {
        return this.updateBuildsResult;
    }

    public void setUpdateBuildsResult(_BuildQueueQueryResult value)
    {
        ...
        throws XMLStreamException
    {
        ...
        do
        {
            ...
            if (event == XMLStreamConstants.START_ELEMENT)
            {
                ...
                {
                    this.updateBuildsResult = new _BuildQueueQueryResult();
                    this.updateBuildsResult.readFromElement(reader);
                }
                else
                {
