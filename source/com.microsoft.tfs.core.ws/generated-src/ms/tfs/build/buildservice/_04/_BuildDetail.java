    ...
    implements ElementSerializable, ElementDeserializable
{
    ...
    protected String lastChangedByDisplayName;
    ...
    public _BuildDetail(
        ...
        final String lastChangedByDisplayName,
        ...
        final long containerId)
    {
        ...
        setLastChangedByDisplayName(lastChangedByDisplayName);
    ...
    {
        return this.lastChangedByDisplayName;
    }

    public void setLastChangedByDisplayName(final String value)
    {
        this.lastChangedByDisplayName = value;
    }
        ...
        throws XMLStreamException
    {
        ...
        for (int i = 0; i < attributeCount; i++)
        {
            ...
            else if (localName.equalsIgnoreCase("LastChangedByDisplayName"))
            {
                this.lastChangedByDisplayName = attributeValue;
            }
        ...
        do
        {
            ...
            if (event == XMLStreamConstants.START_ELEMENT)
            {
                ...
                else if (localName.equalsIgnoreCase("QueueIds"))
                {
                    /*
                     * The element type is an array.
                     */
                    ...
                    this.queueIds = (int[]) PrimitiveArrayHelpers.toArray(
                            list0,
                            Integer.TYPE);
                }
                ...
                else if (localName.equalsIgnoreCase("ContainerId"))
                {
                    this.containerId = XMLConvert.toLong(reader.getElementText());
                }
                else
                {
