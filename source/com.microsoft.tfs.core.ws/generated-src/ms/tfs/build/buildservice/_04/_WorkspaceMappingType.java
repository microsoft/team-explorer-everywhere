 ...
 */
public final class _WorkspaceMappingType
    extends Enumeration
{
    /**
    ...
    public static final _WorkspaceMappingType Map = new _WorkspaceMappingType("Map");
    public static final _WorkspaceMappingType Cloak = new _WorkspaceMappingType("Cloak");

    private _WorkspaceMappingType(final String name)
    {
        super(name, _WorkspaceMappingType.VALUES_TO_INSTANCES);
    }
     ...
     */
    public static _WorkspaceMappingType fromString(final String value)
        throws SOAPSerializationException
    {
        return (_WorkspaceMappingType) Enumeration.fromString(
            value,
            _WorkspaceMappingType.VALUES_TO_INSTANCES);
    }
}
