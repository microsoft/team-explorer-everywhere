 ...
 */
public class _BuildServiceSoap_QueryBuildQueueByIdResponse
    implements ElementDeserializable
{
    // No attributes    

    // Elements
    protected _BuildQueueQueryResult2008 queryBuildQueueByIdResult;

    public _BuildServiceSoap_QueryBuildQueueByIdResponse()
    {
        super();
    }

    public _BuildServiceSoap_QueryBuildQueueByIdResponse(final _BuildQueueQueryResult2008 queryBuildQueueByIdResult)
    {
        // TODO : Call super() instead of setting all fields directly?
        setQueryBuildQueueByIdResult(queryBuildQueueByIdResult);
    }

    public _BuildQueueQueryResult2008 getQueryBuildQueueByIdResult()
    {
        return this.queryBuildQueueByIdResult;
    }

    public void setQueryBuildQueueByIdResult(_BuildQueueQueryResult2008 value)
    {
        this.queryBuildQueueByIdResult = value;
    }
        ...
        throws XMLStreamException
    {
        ...
        do
        {
            ...
            if (event == XMLStreamConstants.START_ELEMENT)
            {
                ...
                if (localName.equalsIgnoreCase("QueryBuildQueueByIdResult"))
                {
                    this.queryBuildQueueByIdResult = new _BuildQueueQueryResult2008();
                    this.queryBuildQueueByIdResult.readFromElement(reader);
                }
                else
                {
