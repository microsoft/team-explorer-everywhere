 ...
 */
public class _BuildServiceSoap_UpdateBuildAgents
    implements ElementSerializable
{
    // No attributes    

    // Elements
    protected _BuildAgent2008[] updates;

    public _BuildServiceSoap_UpdateBuildAgents()
    {
        super();
    }

    public _BuildServiceSoap_UpdateBuildAgents(final _BuildAgent2008[] updates)
    {
        // TODO : Call super() instead of setting all fields directly?
        setUpdates(updates);
    }

    public _BuildAgent2008[] getUpdates()
    {
        return this.updates;
    }

    public void setUpdates(_BuildAgent2008[] value)
    {
        this.updates = value;
    }
