 ...
 */
public final class _AgentStatus
    extends Enumeration
{
    /**
    ...
    public static final _AgentStatus Unavailable = new _AgentStatus("Unavailable");
    public static final _AgentStatus Available = new _AgentStatus("Available");
    public static final _AgentStatus Offline = new _AgentStatus("Offline");

    private _AgentStatus(final String name)
    {
        super(name, _AgentStatus.VALUES_TO_INSTANCES);
    }
     ...
     */
    public static _AgentStatus fromString(final String value)
        throws SOAPSerializationException
    {
        return (_AgentStatus) Enumeration.fromString(
            value,
            _AgentStatus.VALUES_TO_INSTANCES);
    }
}
