 ...
 */
public class _BuildWebServiceSoap_AddBuildDefinitionsResponse
    implements ElementDeserializable
{
    // No attributes    

    // Elements
    protected _BuildDefinition[] addBuildDefinitionsResult;

    public _BuildWebServiceSoap_AddBuildDefinitionsResponse()
    {
        super();
    }

    public _BuildWebServiceSoap_AddBuildDefinitionsResponse(final _BuildDefinition[] addBuildDefinitionsResult)
    {
        // TODO : Call super() instead of setting all fields directly?
        setAddBuildDefinitionsResult(addBuildDefinitionsResult);
    }

    public _BuildDefinition[] getAddBuildDefinitionsResult()
    {
        return this.addBuildDefinitionsResult;
    }

    public void setAddBuildDefinitionsResult(_BuildDefinition[] value)
    {
        this.addBuildDefinitionsResult = value;
    }
        ...
        throws XMLStreamException
    {
        ...
        do
        {
            ...
            if (event == XMLStreamConstants.START_ELEMENT)
            {
                ...
                if (localName.equalsIgnoreCase("AddBuildDefinitionsResult"))
                {
                    /*
                    ...
                    this.addBuildDefinitionsResult = (_BuildDefinition[]) list0.toArray(
