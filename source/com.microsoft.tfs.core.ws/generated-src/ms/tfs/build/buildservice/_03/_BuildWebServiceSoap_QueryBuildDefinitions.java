 ...
 */
public class _BuildWebServiceSoap_QueryBuildDefinitions
    implements ElementSerializable
{
    // No attributes    

    // Elements
    protected _BuildDefinitionSpec[] specs;

    public _BuildWebServiceSoap_QueryBuildDefinitions()
    {
        super();
    }

    public _BuildWebServiceSoap_QueryBuildDefinitions(final _BuildDefinitionSpec[] specs)
    {
        // TODO : Call super() instead of setting all fields directly?
        setSpecs(specs);
    }

    public _BuildDefinitionSpec[] getSpecs()
    {
        return this.specs;
    }

    public void setSpecs(_BuildDefinitionSpec[] value)
    {
        this.specs = value;
    }
