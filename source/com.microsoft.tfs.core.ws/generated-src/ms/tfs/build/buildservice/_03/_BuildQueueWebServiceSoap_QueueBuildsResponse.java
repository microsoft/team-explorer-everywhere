 ...
 */
public class _BuildQueueWebServiceSoap_QueueBuildsResponse
    implements ElementDeserializable
{
    // No attributes    

    // Elements
    protected _QueuedBuild[] queueBuildsResult;

    public _BuildQueueWebServiceSoap_QueueBuildsResponse()
    {
        super();
    }

    public _BuildQueueWebServiceSoap_QueueBuildsResponse(final _QueuedBuild[] queueBuildsResult)
    {
        // TODO : Call super() instead of setting all fields directly?
        setQueueBuildsResult(queueBuildsResult);
    }

    public _QueuedBuild[] getQueueBuildsResult()
    {
        return this.queueBuildsResult;
    }

    public void setQueueBuildsResult(_QueuedBuild[] value)
    {
        ...
        do
        {
            ...
            if (event == XMLStreamConstants.START_ELEMENT)
            {
                ...
                if (localName.equalsIgnoreCase("QueueBuildsResult"))
                {
                    ...
                    this.queueBuildsResult = (_QueuedBuild[]) list0.toArray(new _QueuedBuild[list0.size()]);
                }
                else
                {
