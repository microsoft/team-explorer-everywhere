 ...
 *
 * {http://tempuri.org/}BuildQueueWebServiceSoapService
 */
public class _BuildQueueWebServiceSoapService
    extends SOAP11Service
    implements _BuildQueueWebServiceSoap
{
    private static final QName PORT_QNAME = new QName("http://tempuri.org/", "BuildQueueWebServiceSoapService");
    private static final String ENDPOINT_PATH = "/tfs/DefaultCollection/Build/v3.0/BuildQueueService.asmx";

    public _BuildQueueWebServiceSoapService(
        final URI endpoint,
        final QName port)
    {
        super(endpoint, port);
    ...
    {
        return _BuildQueueWebServiceSoapService.PORT_QNAME;
    }
    ...
    {
        return _BuildQueueWebServiceSoapService.ENDPOINT_PATH;
    }
