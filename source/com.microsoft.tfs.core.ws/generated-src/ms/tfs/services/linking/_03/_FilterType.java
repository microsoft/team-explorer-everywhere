 ...
 */
public final class _FilterType
    extends Enumeration
{
    /**
    ...
    public static final _FilterType ToolType = new _FilterType("ToolType");
    public static final _FilterType ArtifactType = new _FilterType("ArtifactType");
    public static final _FilterType LinkType = new _FilterType("LinkType");

    private _FilterType(final String name)
    {
        super(name, _FilterType.VALUES_TO_INSTANCES);
    }
     ...
     */
    public static _FilterType fromString(final String value)
        throws SOAPSerializationException
    {
        return (_FilterType) Enumeration.fromString(
            value,
            _FilterType.VALUES_TO_INSTANCES);
    }
}
