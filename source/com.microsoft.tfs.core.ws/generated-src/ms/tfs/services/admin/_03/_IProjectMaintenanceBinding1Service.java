 ...
 *
 * {http://schemas.microsoft.com/TeamFoundation/2005/06/Services/Admin/03}IProjectMaintenanceBinding1Service
 */
public class _IProjectMaintenanceBinding1Service
    extends SOAP12Service
    implements _IProjectMaintenanceBinding
{
    private static final QName PORT_QNAME = new QName(
                "http://schemas.microsoft.com/TeamFoundation/2005/06/Services/Admin/03",
                "IProjectMaintenanceBinding1Service");
    private static final String ENDPOINT_PATH = "/tfs/DefaultCollection/WorkItemTracking/v1.0/Integration.asmx";

    public _IProjectMaintenanceBinding1Service(
        final URI endpoint,
        final QName port)
    {
        super(endpoint, port);
    ...
    {
        return _IProjectMaintenanceBinding1Service.PORT_QNAME;
    }
    ...
    {
        return _IProjectMaintenanceBinding1Service.ENDPOINT_PATH;
    }

    public boolean deleteProject(final String projectUri)
        throws TransportException, SOAPFault
    {
        final _IProjectMaintenanceBinding_DeleteProject requestData = new _IProjectMaintenanceBinding_DeleteProject(
                    projectUri);
        ...
        final _IProjectMaintenanceBinding_DeleteProjectResponse responseData = new _IProjectMaintenanceBinding_DeleteProjectResponse();
        ...
        return responseData.isDeleteProjectResult();
    }
}
