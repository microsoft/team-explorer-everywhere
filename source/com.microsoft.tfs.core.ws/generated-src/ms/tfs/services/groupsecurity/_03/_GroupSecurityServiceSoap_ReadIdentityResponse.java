 ...
 */
public class _GroupSecurityServiceSoap_ReadIdentityResponse
    implements ElementDeserializable
{
    ...
    public _GroupSecurityServiceSoap_ReadIdentityResponse(final _Identity readIdentityResult)
    {
        // TODO : Call super() instead of setting all fields directly?
        setReadIdentityResult(readIdentityResult);
    }
    ...
    public void setReadIdentityResult(_Identity value)
    {
        this.readIdentityResult = value;
    }
        ...
        throws XMLStreamException
    {
        ...
        do
        {
            ...
            if (event == XMLStreamConstants.START_ELEMENT)
            {
                ...
                if (localName.equalsIgnoreCase("ReadIdentityResult"))
                {
                    this.readIdentityResult = new _Identity();
                    this.readIdentityResult.readFromElement(reader);
                }
                else
                {
