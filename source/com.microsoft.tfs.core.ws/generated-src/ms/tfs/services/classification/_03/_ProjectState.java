 ...
 */
public final class _ProjectState
    extends Enumeration
{
    /**
    ...
    public static final _ProjectState New = new _ProjectState("New");
    public static final _ProjectState WellFormed = new _ProjectState("WellFormed");
    public static final _ProjectState Deleting = new _ProjectState("Deleting");

    private _ProjectState(final String name)
    {
        super(name, _ProjectState.VALUES_TO_INSTANCES);
    }
     ...
     */
    public static _ProjectState fromString(final String value)
        throws SOAPSerializationException
    {
        return (_ProjectState) Enumeration.fromString(
            value,
            _ProjectState.VALUES_TO_INSTANCES);
    }
}
