 ...
 */
public class _ReportingService2005Soap_FindItemsResponse
    implements ElementDeserializable
{
    ...
    public _ReportingService2005Soap_FindItemsResponse(final _CatalogItem[] items)
    {
    ...
    public void setItems(_CatalogItem[] value)
    {
        this.items = value;
    }
        ...
        do
        {
            ...
            if (event == XMLStreamConstants.START_ELEMENT)
            {
                ...
                if (localName.equalsIgnoreCase("Items"))
                {
                    ...
                    this.items = (_CatalogItem[]) list0.toArray(new _CatalogItem[list0.size()]);
                }
                else
                {
