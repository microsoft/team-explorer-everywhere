 ...
 */
public class _ReportingService2005Soap_GetDataDrivenSubscriptionPropertiesResponse
    implements ElementDeserializable
{
    ...
    public _ReportingService2005Soap_GetDataDrivenSubscriptionPropertiesResponse()
    {
        super();
    }
        ...
        throws XMLStreamException
    {
        ...
        do
        {
            ...
            if (event == XMLStreamConstants.START_ELEMENT)
            {
                ...
                else if (localName.equalsIgnoreCase("DataRetrievalPlan"))
                {
                    this.dataRetrievalPlan = new _DataRetrievalPlan();
                    this.dataRetrievalPlan.readFromElement(reader);
                }
                ...
                else if (localName.equalsIgnoreCase("Parameters"))
                {
                    ...
                    do
                    {
                        ...
                        {
                            _ParameterValueOrFieldReference complexObject0 = new _ParameterValueOrFieldReference();
                    ...
                    this.parameters = (_ParameterValueOrFieldReference[]) list0.toArray(
                                new _ParameterValueOrFieldReference[list0.size()]);
                }
                else
                {
