 ...
 */
public final class _ScheduleStateEnum
    extends Enumeration
{
    /**
    ...
    private _ScheduleStateEnum(final String name)
    {
        super(name, _ScheduleStateEnum.VALUES_TO_INSTANCES);
    }
     ...
     */
    public static _ScheduleStateEnum fromString(final String value)
        throws SOAPSerializationException
    {
        return (_ScheduleStateEnum) Enumeration.fromString(
            value,
            _ScheduleStateEnum.VALUES_TO_INSTANCES);
    }
}
