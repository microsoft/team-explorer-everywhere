 ...
 */
public class _MinuteRecurrence
    ...
    implements ElementSerializable, ElementDeserializable
{
    ...
    public _MinuteRecurrence()
    {
        super();
    }

    public _MinuteRecurrence(final int minutesInterval)
    {
        ...
        throws XMLStreamException
    {
        ...
        do
        {
            ...
            if (event == XMLStreamConstants.START_ELEMENT)
            {
                ...
                if (localName.equalsIgnoreCase("MinutesInterval"))
                {
                    this.minutesInterval = XMLConvert.toInt(reader.getElementText());
                }
                else
                {
