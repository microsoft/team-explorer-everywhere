 ...
 */
public final class _SensitivityEnum
    extends Enumeration
{
    /**
    ...
    private _SensitivityEnum(final String name)
    {
        super(name, _SensitivityEnum.VALUES_TO_INSTANCES);
    }
     ...
     */
    public static _SensitivityEnum fromString(final String value)
        throws SOAPSerializationException
    {
        return (_SensitivityEnum) Enumeration.fromString(
            value,
            _SensitivityEnum.VALUES_TO_INSTANCES);
    }
}
