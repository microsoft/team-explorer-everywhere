 ...
 */
public class _ReportingService2005Soap_CreateReportHistorySnapshotResponse
    implements ElementDeserializable
{
    ...
    public _ReportingService2005Soap_CreateReportHistorySnapshotResponse()
    {
        super();
    }
        ...
        throws XMLStreamException
    {
        ...
        do
        {
            ...
            if (event == XMLStreamConstants.START_ELEMENT)
            {
                ...
                else if (localName.equalsIgnoreCase("Warnings"))
                {
                    /*
