 ...
 */
public class _ReportingService2005Soap_GetDataDrivenSubscriptionProperties
    implements ElementSerializable
{
    ...
    public _ReportingService2005Soap_GetDataDrivenSubscriptionProperties()
    {
        super();
    }

    public _ReportingService2005Soap_GetDataDrivenSubscriptionProperties(final String dataDrivenSubscriptionID)
    {
