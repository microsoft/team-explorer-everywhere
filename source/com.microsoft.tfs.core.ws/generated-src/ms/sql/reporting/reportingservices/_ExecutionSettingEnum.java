 ...
 */
public final class _ExecutionSettingEnum
    extends Enumeration
{
    /**
    ...
    public static final _ExecutionSettingEnum Live = new _ExecutionSettingEnum("Live");
    public static final _ExecutionSettingEnum Snapshot = new _ExecutionSettingEnum("Snapshot");

    private _ExecutionSettingEnum(final String name)
    {
        super(name, _ExecutionSettingEnum.VALUES_TO_INSTANCES);
    }
     ...
     */
    public static _ExecutionSettingEnum fromString(final String value)
        throws SOAPSerializationException
    {
        return (_ExecutionSettingEnum) Enumeration.fromString(
            value,
            _ExecutionSettingEnum.VALUES_TO_INSTANCES);
    }
}
