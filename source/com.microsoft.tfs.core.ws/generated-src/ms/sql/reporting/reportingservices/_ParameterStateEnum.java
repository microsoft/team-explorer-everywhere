 ...
 */
public final class _ParameterStateEnum
    extends Enumeration
{
    /**
    ...
    public static final _ParameterStateEnum HasOutstandingDependencies = new _ParameterStateEnum(
                "HasOutstandingDependencies");
    public static final _ParameterStateEnum DynamicValuesUnavailable = new _ParameterStateEnum(
            "DynamicValuesUnavailable");

    private _ParameterStateEnum(final String name)
    {
        super(name, _ParameterStateEnum.VALUES_TO_INSTANCES);
    }
     ...
     */
    public static _ParameterStateEnum fromString(final String value)
        throws SOAPSerializationException
    {
        return (_ParameterStateEnum) Enumeration.fromString(
            value,
            _ParameterStateEnum.VALUES_TO_INSTANCES);
    }
}
