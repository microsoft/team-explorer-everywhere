 ...
 */
public final class _BooleanOperatorEnum
    extends Enumeration
{
    /**
    ...
    public static final _BooleanOperatorEnum And = new _BooleanOperatorEnum("And");
    public static final _BooleanOperatorEnum Or = new _BooleanOperatorEnum("Or");

    private _BooleanOperatorEnum(final String name)
    {
        super(name, _BooleanOperatorEnum.VALUES_TO_INSTANCES);
    }
     ...
     */
    public static _BooleanOperatorEnum fromString(final String value)
        throws SOAPSerializationException
    {
        return (_BooleanOperatorEnum) Enumeration.fromString(
            value,
            _BooleanOperatorEnum.VALUES_TO_INSTANCES);
    }
}
