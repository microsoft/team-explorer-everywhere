...
package com.microsoft.tfs.util.base64;
...
public class Base64 implements BinaryEncoder, BinaryDecoder {
    ...
    public static boolean isArrayByteBase64(final byte[] arrayOctet) {
        return isArrayByteBase64(arrayOctet);
    }
     ...
     *        true to ignore whitespace characters (default per RFC)
     * @return true if all bytes are valid characters in the Base64 alphabet or
     *         if the byte array is empty; false, otherwise
     */
    public static boolean isArrayByteBase64(byte[] arrayOctet, final boolean ignoreWhitespace) {
        if (ignoreWhitespace) {
