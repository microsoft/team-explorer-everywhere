...
/**
 * An HttpClient request entity implementation suited for SOAP 1.2 request use.
 */
public class SOAPRequestEntity12 extends SOAPRequestEntity {
    public SOAPRequestEntity12(
    ...
    public String getContentType() {
        return "application/soap+xml; charset=" + SOAP_ENCODING; //$NON-NLS-1$
    }
    ...
    public void writeRequest(final OutputStream out) throws IOException {
        ...
        try {
            ...
            writer.writeNamespace("soap", Schemas.SOAP_12); //$NON-NLS-1$
            ...
            if (getSoapHeaderProvider() != null) {
                writer.writeStartElement("soap", "Header", Schemas.SOAP_12); //$NON-NLS-1$ //$NON-NLS-2$

                // TODO make the soap header deserializable
                DOMAnyContentType.writeElement(writer, getSoapHeaderProvider().getSOAPHeader());

                writer.writeEndElement();
            }

            writer.writeStartElement("soap", "Body", Schemas.SOAP_12); //$NON-NLS-1$ //$NON-NLS-2$
