 ...
 * //httpclient/src/java/org/apache/commons/httpclient/HttpStatus.java,v 1.18
 * 2004/05/02 11:21:13 olegk Exp $ $Revision: 480424 $ $Date: 2006-11-29
...
public class HttpStatus {
    ...
    public static String getStatusText(final int statusCode) {
        ...
        if (classIndex < 1
            || classIndex > (REASON_PHRASES.length - 1)
            || codeIndex < 0
    ...
    public static boolean isSuccessFamily(final int statusCode) {
