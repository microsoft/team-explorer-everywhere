 ...
 * //httpclient/src/java/org/apache/commons/httpclient/HeaderElement.java,v 1.23
...
public class HeaderElement extends NameValuePair {
    ...
    public HeaderElement(final char[] chars, final int offset, final int length) {
        ...
        if (params.size() > 0) {
            final NameValuePair element = (NameValuePair) params.remove(0);
     ...
     *
     * @param headerValue
     *        the array of char representation of the header value (as received
     *        from the web server).
     ...
     *
     * @param headerValue
     *        the string representation of the header value (as received from
     *        the web server).
     * @return array of {@link HeaderElement}s.
     *
     * @since 3.0
    ...
    public NameValuePair getParameterByName(final String name) {
        ...
        final NameValuePair parameters[] = getParameters();
        if (parameters != null) {
