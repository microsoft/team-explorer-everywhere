 ...
 * /HTTPCLIENT_3_1
 * /src/java/org/apache/commons/httpclient/util/ParameterFormatter.java $
 ...
 * <a href="http://www.w3.org/Protocols/rfc2616/rfc2616-sec2.html#sec2.1">
 * Section 2.1</a> and
...
public class ParameterFormatter {
     ...
     * @param alwaysUseQuotes
     *        <tt>true</tt> if the parameter value must be enclosed in quotation
     *        marks, even if it does not contain any special characters
     *        <tt>, false</tt> only if the parameter value contains potentially
    ...
    public void format(final StringBuffer buffer, final NameValuePair param) {
        ...
        if (value != null) {
            buffer.append("=");
            formatValue(buffer, value, alwaysUseQuotes);
        }
    }
