...
/**
 * <p>
 * Javascript-callable function called when the page is loaded and the "editor"
 ...
 */
final class EditorReadyFunction extends BrowserFunction {
    private final HTMLEditor editor;

    public EditorReadyFunction(final Browser browser, final String name, final HTMLEditor editor) {
        super(browser, name);
