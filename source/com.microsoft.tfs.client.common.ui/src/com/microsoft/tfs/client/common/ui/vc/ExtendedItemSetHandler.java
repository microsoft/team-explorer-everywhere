...
public class ExtendedItemSetHandler {
    public interface ExtendedItemSetVisitor {
        public Object visit(ExtendedItem item, Object parent) throws CanceledException;
    }

    public static Object handleItemSet(final ExtendedItem[] items, final ExtendedItemSetVisitor visitor)
        ...
        for (int i = 0; i < items.length; i++) {
             ...
             * separator character.
             */
            final String parentPath = ServerPath.getParent(items[i].getSourceServerItem());
             ...
             * character.
             */
            final String serverItem = items[i].getSourceServerItem();
