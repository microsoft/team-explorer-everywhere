...
/**
 * <p>
 * Javascript-callable function called when the mouse enters the region over a
 * link.
 * </p>
 * <h2>WARNING</h2>
 * <p>
 ...
 */
final class MouseLinkEnterFunction extends BrowserFunction {
    private final HTMLEditor editor;

    public MouseLinkEnterFunction(final Browser browser, final String name, final HTMLEditor editor) {
        super(browser, name);
    ...
    /**
     * Handles a mouse move into the region over a link.
     *
     * @param arguments
     *        ignored
     * @return null
