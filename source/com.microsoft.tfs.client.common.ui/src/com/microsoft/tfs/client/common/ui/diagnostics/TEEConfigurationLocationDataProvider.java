...
public class TEEConfigurationLocationDataProvider extends NonLocalizedDataProvider implements DataProvider {
    @Override
    public Object getData() {
        return DefaultPersistenceStoreProvider.INSTANCE.getConfigurationPersistenceStore().getStoreFile();
    }
}
