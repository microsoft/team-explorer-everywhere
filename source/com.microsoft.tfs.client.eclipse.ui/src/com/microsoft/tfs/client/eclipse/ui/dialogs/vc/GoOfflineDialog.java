...
public class GoOfflineDialog extends BaseDialog {
    ...
    public GoOfflineDialog(final Shell shell) {
        super(shell);
    }

    @Override
    protected String provideDialogTitle() {
        return Messages.getString("GoOfflineDialog.DialogTitle"); //$NON-NLS-1$
    }
    ...
    protected void hookAddToDialogArea(final Composite dialogArea) {
        ...
        descriptionLabel.setText(Messages.getString("GoOfflineDialog.DescriptionLabelText")); //$NON-NLS-1$
