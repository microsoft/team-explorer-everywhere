 ...
 * @since TEE-SDK-10.1
 */
public class UndoOperationStartedEvent extends OperationStartedEvent {
    private final ItemSpec[] items;

    public UndoOperationStartedEvent(final EventSource source, final Workspace workspace, final ItemSpec[] items) {
