...
public class WIIntegerTypeConverter implements WITypeConverter {
    @Override
        ...
        if (input != null) {
            if (input instanceof Integer) {
                ...
                try {
                    ...
                    throw new WITypeConverterException("unable to convert input to an int", ex); //$NON-NLS-1$
                }
            } else {
                throw new WITypeConverterException(MessageFormat.format(
                    "unable to convert [{0}] to an int", //$NON-NLS-1$
