...
public final class ScheduleDays extends FlagSetWrapper {
    /**
     * Wraps the web service flag type as a {@link ScheduleDays.Day}.
     */
    ...
    /**
     * Constructs a {@link ScheduleDays} with no days initially set.
     */
    public ScheduleDays() {
    ...
    /**
     * Constructs a {@link ScheduleDays} that wraps the given
     * {@link _ScheduleDays}.
     *
     * @param scheduleDays
     *        the inner {@link _ScheduleDays} (must not be <code>null</code>)
     */
    public ScheduleDays(final _ScheduleDays scheduleDays) {
        super(scheduleDays);
    ...
    /**
     * Constructs a {@link ScheduleDays} with the given single day initially
     * set.
     */
    public ScheduleDays(final Day value) {
        this();
        add(value);
    }

    /**
     * Constructs a {@link ScheduleDays} with the given days initially set.
     */
    public ScheduleDays(final Day[] values) {
        this();
        addAll(values);
    }
    ...
    public void addAll(final ScheduleDays flagSetWrapper) {
    ...
    public boolean containsAll(final ScheduleDays flagSetWrapper) {
        return super.containsAll(flagSetWrapper);
    }

    public boolean containsAny(final ScheduleDays flagSetWrapper) {
    ...
    public boolean removeAll(final ScheduleDays flagSetWrapper) {
